...
```
Error: locator.check: Error: strict mode violation: getByRole('radio', { name: 'Chrome' }) resolved to 2 elements:
...
Call log:
  - waiting for getByRole('radio', { name: 'Chrome' })
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0gpetwly2boazc6ibwyw15umt19707035.node0
      - text: 
...
```ts
  ...
  4 |     const radio=await page.getByRole("radio",{name:"Chrome"})

...
```ts
  ...
  8  |   await page.getByRole('textbox', { name: '* First Name' }).fill('ravi');
  ...
  12 |   await page.getByRole('textbox', { name: '* E-Mail' }).fill('ravi33@gmail.com');
  13 |   await page.getByRole('textbox', { name: '* Telephone' }).click();
  14 |   await page.getByRole('textbox', { name: '* Telephone' }).fill('8976748794');
  15 |   await page.getByRole('textbox', { name: '* Password', exact: true }).click();
  16 |   await page.getByRole('textbox', { name: '* Password', exact: true }).fill('ravi@123');
  17 |   await page.getByRole('textbox', { name: '* Password Confirm' }).click();
  18 |   await page.getByRole('textbox', { name: '* Password Confirm' }).fill('ravi@123');
...
> 21 |   await expect(page.getByRole('heading', { name: 'Your Account Has Been Created!' })).toBeVisible();
  ...
  30 |   await page.getByRole('textbox', { name: 'E-Mail Address' }).fill('ravi33@gmail.com');
  31 |   await page.getByRole('textbox', { name: 'Password' }).click();
  32 |   await page.getByRole('textbox', { name: 'Password' }).fill('ravi@123');

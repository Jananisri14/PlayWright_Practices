...
Call log:
  - waiting for getByLabel('Edge').nth(1)
    - locator resolved to <input type="radio" value="Option4" id="j_idt87:console2:3" name="j_idt87:console2"/>
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node01tkqhu33lbz60xlwguq4al5az19708392.node0
      - text: 
...
```ts
  ...
  4 |     const radio = page.getByLabel('Edge').nth(1);
> 5 |     await radio.check();
    |                 ^ Error: locator.check: Test timeout of 30000ms exceeded.

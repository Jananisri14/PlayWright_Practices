...
```
Error: locator.click: Error: strict mode violation: getByRole('radio', { name: 'Chrome' }) resolved to 2 elements:
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0122na75b5plfm1tf4xxajdmltl19706887.node0
      - text: 
...
> 4 |     await page.getByRole("radio",{name:"Chrome"}).click();
    |                                                   ^ Error: locator.click: Error: strict mode violation: getByRole('radio', { name: 'Chrome' }) resolved to 2 elements:
  5 | 
  6 | 
  7 | });

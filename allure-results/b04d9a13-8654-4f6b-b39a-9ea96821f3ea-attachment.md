...
- text: E-Mail Address
- textbox "E-Mail Address": ravi33@gmail.com
- text: Password
- textbox "Password": ravi@123
...
```ts
  ...
  8  |   await page.getByRole('textbox', { name: 'E-Mail Address' }).fill('ravi33@gmail.com');
  9  |   await page.getByRole('textbox', { name: 'Password' }).click();
  10 |   await page.getByRole('textbox', { name: 'Password' }).fill('ravi@123');

...
```
Error: locator.check: Error: strict mode violation: getByLabel('Edge') resolved to 2 elements:
    1) <input value="" type="radio" id="j_idt87:console1:3" name="j_idt87:console1"/> aka getByRole('radio', { name: 'Edge' }).first()
    2) <input type="radio" value="Option4" id="j_idt87:console2:3" name="j_idt87:console2"/> aka getByRole('radio', { name: 'Edge' }).nth(1)

Call log:
  - waiting for getByLabel('Edge')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node01b60kkb3vzravgqua1enmv4t319708105.node0
      - text: 
...
```ts
  ...
  4 |     const radio=await page.getByLabel('Edge')
> 5 |     await radio.check();
    |                 ^ Error: locator.check: Error: strict mode violation: getByLabel('Edge') resolved to 2 elements:
